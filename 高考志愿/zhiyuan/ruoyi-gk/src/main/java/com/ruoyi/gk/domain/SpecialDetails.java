...
public class SpecialDetails {
    ...
    /** 就业分布数据 */
    @Excel(name = "就业分布数据")
    private List<SpecialEmployLocation> employmentAreas;

    /** 就业岗位分布数据 */
    @Excel(name = "就业岗位分布数据")
    private List<SpecialEmployPositions> employmentPositions;
    ...
    private List<SpecialJobDetails> employmentDistribution;
}
